    ...
    const filteredData = useMemo(() => {
        ...
        switch (activeFilter) {
            ...
            case 'Tutorials':
                ...
                break
            default:
                // Fallback: Just show Educators if something unexpected
                data = educators.map((item) => ({ ...item, contentType: 'Educator' }))
                break
        }
        ...
        <Page>
            ...
            <div className="relative min-h-screen bg-cosmos-bg bg-fixed bg-center bg-no-repeat bg-cover">
                ...
                <div className="relative z-10">
                    {/* Filters */}
                    <div className="flex flex-col justify-between bg-white dark:bg-zinc-900 rounded-2xl mx-2 shadow-lg p-0 py-0 mt-4">
                            ...
                            <div key="ai-chat" className="relative cursor-pointer">
                                ...
                                <div className="relative same-height-card flex flex-col items-center text-center p-0 !mb-4 !m-2 rounded-2xl shadow-lg overflow-visible z-10 bg-white dark:bg-zinc-900 coinbeats-content border-none">
                                    ...
                                    <Button
                                        outline
                                        rounded
                                        className=" mt-4 font-bold text-md shadow-xl !h-6 !mb-3 w-[88px] md:w-[60%]"
                                        style={{
