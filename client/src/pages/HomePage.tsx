            ...
            <div className="relative min-h-screen bg-cosmos-bg bg-fixed bg-center bg-no-repeat bg-cover">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-row justify-center items-center mb-2 mt-2">
                        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg p-1 flex flex-col items-center px-1 m-2 mr-1 border border-gray-300 dark:border-gray-600 h-auto ml-4">
                            {/* "Your Coins" card */}
