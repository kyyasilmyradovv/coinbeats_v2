...
const CreateAcademyPage: React.FC = () => {
    ...
    const renderIntroSlide = () => (
        <Card key="slide-intro" className="!mb-2 !p-0 !rounded-2xl shadow-lg !mx-4 relative border border-gray-300 dark:border-gray-600">
            ...
            <p className="text-center mb-6">Let's now add a multiple-choice quiz for each lesson to make sure people are learning?</p>
            <Button onClick={nextStep} className="w-full bg-brand-primary text-white rounded-full mt-4 mb-2" large raised>
                Yes, let's add quizzes
            </Button>
            <Button onClick={handleSubmitBasic} className="w-full !bg-gray-500 text-white rounded-full" large raised>
    ...
    const renderAcademyDetailsSlide = () => (
        <Card key="slide-details" className="!mb-2 !p-0 !rounded-2xl shadow-lg !mx-4 relative border border-gray-300 dark:border-gray-600">
            <div className="flex items-center justify-center relative">
            ...
            <List>
                ...
                <div className="relative mb-4">
                    ...
                    {logo && (
                        <div className="relative mt-2">
                            <img src={handleImagePreview(logo) ?? ''} alt="Logo Preview" className="w-32 h-32 object-cover" />
                ...
                <div className="relative mb-10">
                    ...
                    {coverPhoto && (
                        <div className="relative mt-2">
                            <img src={handleImagePreview(coverPhoto) ?? ''} alt="Cover Photo Preview" className="w-full h-48 object-cover" />
    ...
    const renderSocialLinksSlide = () => (
        <Card key="slide-social-links" className="!mb-2 !p-0 !rounded-2xl shadow-lg !mx-4 relative border border-gray-300 dark:border-gray-600">
            <div className="flex items-center justify-center relative">
                ...
                {visibleTooltip === 2 && (
                    <div className="tooltip absolute bg-gray-700 text-white text-xs rounded-2xl p-4 mt-2 z-20">
                        Enter the social media links for your academy. These links will help users connect with your academy on various platforms like Twitter,
    ...
    const renderReviewSlide = () => (
        <Card key="slide-review" className="!mb-2 !p-0 !rounded-2xl shadow-lg !mx-4 relative border border-gray-300 dark:border-gray-600">
            <div className="flex items-center justify-center relative">
            ...
            <div className="mb-4">
                ...
                {logo ? <img src={handleImagePreview(logo) || undefined} alt="Logo Preview" className="mt-2 w-32 h-32 object-cover" /> : <p>N/A</p>}
            </div>
            <div className="mb-4">
                <h3 className="font-medium">Cover Photo:</h3>
                {coverPhoto ? (
                    <img src={handleImagePreview(coverPhoto) || undefined} alt="Cover Photo Preview" className="mt-2 w-full h-48 object-cover" />
                ) : (
                    <p>N/A</p>
                )}
            </div>
                    ...
                    <div key={index} className="mb-4">
                        ...
                        {index === 3 ? (
                            <div className="ml-4">
                                ...
                                <p>
                                    <strong>Token Utility:</strong> {question.utility || 'N/A'}
                                </p>
                                <p>
                                    <strong>Total Supply:</strong> {question.totalSupply || 'N/A'}
                                </p>
                                <p>
                                    <strong>Tokenomics Logic and Issuance:</strong> {question.logic || 'N/A'}
                                </p>
                                <p>
                                    <strong>CoinGecko Link:</strong> {question.coingecko || 'N/A'}
                                </p>
                                <p>
                                    <strong>DexScreener Link:</strong> {question.dexScreener || 'N/A'}
                                </p>
                                <p>
                                    <strong>Contract Address:</strong> {question.contractAddress || 'N/A'}
                                </p>
                            </div>
                        ) : (
                    ...
                    <div key={index} className="mb-4">
                        ...
                        <ul className="list-disc ml-5">
                            {question.choices.slice(0, 4).map((choice, choiceIndex) => (
                                <li key={choiceIndex}>
                                    {choice.answer || 'N/A'} {choice.correct && '(Correct)'}
                                </li>
                            ))}
                        </ul>
                    </div>
            ...
            <List>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    {categories.map((category, index) => (
                        <div key={index} className="relative">
                            <span onClick={() => removeCategory(index)} className="dark:bg-blue-600 bg-blue-200 px-2 py-1 rounded-lg">
                                {category}
                            </span>
                        </div>
                    ))}
